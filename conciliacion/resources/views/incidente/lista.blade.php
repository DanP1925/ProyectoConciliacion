                ...
                <div class="cell small-12">
                    ...
                    @endif
                        <div class="list-text-5-div">
                            <a href="{{ url('/incidente/editar',['idIncidente' => $incidente['idIncidente'],'flgInicio' => 'S']) }}">
                        ...
                        <div class="list-text-5-div">
                            <div class="list-line-div">
                                <div idBorrar="{{ $incidente['idIncidente'] }}" class="btn-borrar-incidente list-edit-icon-div">
