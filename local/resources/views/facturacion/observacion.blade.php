            ...
            <div class="cell small-12">
                <div class="table-2cells-div">
                    ...
                    <div class="right-div">
                        ...
                        @endif
                             <div id="btn-regresar" class="site-title-buttonfloat-right">
                                Regresar
                            </div>
                        </a>
                        <div id="btn-registrar-observacion" class="site-title-button site-title-button-padding float-right">
                ...
                <div class="grid-x grid-margin-x">
                    <div class="cell small-12 large-8">
                        <div class="site-line">
                            ...
                            <div class="site-control">
                                <div class="site-control-border">
                                    <textarea type="text" class="site-textarea" id="observacion" name="observacion"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
