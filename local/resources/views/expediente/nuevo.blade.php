        ...
        <div class="grid-x">
            <div class="cell small-12">
                <div class="table-2cells-div padding-top-30 padding-bottom-40">
                    ...
                    <div class="right-div">
						<input type="hidden" id="accionRegistrar" name="accionRegistrar" value="nuevoExpediente"/>
                                    ...
                                    @foreach ($expedienteTemporal->recursos as $recurso)
                                        ...
                                        @endif
                                                ...
                                                <div class="list-edit-icon-div">
                                                    <button type="submit" formaction="{{ url('expediente/recurso/editar', []) }}" name="accion" value="editarRecurso {{$loop->index}}" onclick="buscarRecurso()">
...
function esNumeroValido(){
	...
	@foreach($listaExpedientes as $expediente)
		if (numeroExpediente == "{{$expediente}}"){
			return true;
		}
	@endforeach
	return false;
