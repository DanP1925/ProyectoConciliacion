            ...
            <div class="cell small-12">
                <div class="table-2cells-div">
                    ...
                    <div class="right-div">
                        ...
                        <div id="btn-editar-propuesta" class="site-title-button site-title-button-padding float-right">
                            Editar Propuesta
                        </div>
                                ...
                                @endif
                                    <div class="list-text-2-div">
                                        ...
                                        <div class="list-sublabel-avant-garde-regular">
                                            Propuesta: <strong>{{ $propuesta['fecha'] }}</strong>
                                        </div>
                                    </div>
...
<script>
    ...
    var urlRegistrarPropuesta = '{{ url('/designacion/editar/registrar') }}';
    ...
    $("#btn-editar-propuesta").click(function() {
