            ...
            <div class="cell small-12">
                <div class="table-2cells-div">
                    ...
                    <div class="right-div">
                        ...
                        <div id="btn-editar-incidente" class="site-title-button site-title-button-padding float-right">
                            Editar Incidente
                        </div>
                ...
                <div class="grid-x grid-margin-x">
                    ...
                    <div class="cell small-12 large-4">
                        <div class="site-line">
                            ...
                            <div class="site-control">
                                <div class="site-control-border">
                                    <input type="text" id="tipoNombre" name="tipoNombre" class="site-input" value="{{ $objIncidente['tipo_nombre'] }}" readonly />
                                    <input type="hidden" id="tipoIncidente" name="tipoIncidente" value="{{ $objIncidente['tipo'] }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-x grid-margin-x">
                    <div class="cell small-12 large-4">
                        <div class="site-line">
                            ...
                            <div class="site-control">
                                <div class="site-control-border">
                                    <input type="date" class="site-input" id="fechaIncidente" name="fechaIncidente" value="{{ $objIncidente['fecha_incidente'] }}" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    var urlEditarIncidente = '{{ url('/incidente/editar/registrar') }}';
    ...
    if($('#tipoIncidente').val()==1){  // Lista Recusacion
        $('#lstRecusante').show();
        $('#lstRenunciante').hide();
    } else {
        if($('#tipoIncidente').val()==2){  // Lista Renuncia
            $('#lstRecusante').hide();
            $('#lstRenunciante').show();
        } else {
            $('#lstRecusante').hide();
    ...
    $('#tipoIncidente').on('change', function() {
    ...
    $("#btn-editar-incidente").click(function() {
        var cont = 0;
    ...
    $("#btn-borrar-01").click(function() {
        ...
        var _urlEditarIncidente = urlEditarIncidente+'/'+idIncidente;
